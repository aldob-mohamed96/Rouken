...
class building_to_selling extends StatefulWidget {
  @override
  _building_to_sellingState createState() => _building_to_sellingState();
}
building show_details;
class _building_to_sellingState extends State<building_to_selling>
  ...
  String time='اقل من ساعه';
     ...
     List<building> building_subcategory_id_9=[];
     List<building> building_subcategory_id_10=[];
     List<building> building_subcategory_id_11=[];
     List<building> building_subcategory_id_12=[];
  ...
  int number_catergory=int.parse( u['subcategory_id'].toString());
         ...
         else if(number_catergory==8)
     {
      setState(() {
       ...
       else if(number_catergory==9)
     {
       setState(() {
        building_subcategory_id_9.add(b1); 
       });
        
     }
       else if(number_catergory==10)
     {
     setState(() {
        building_subcategory_id_10.add(b1); 
     });
        
     }
      else if(number_catergory==11)
     {
      setState(() {
        building_subcategory_id_11.add(b1); 
      });
        
     }
      else if(number_catergory==12)
     {
       setState(() {
        building_subcategory_id_12.add(b1); 
       });
        ...
        child: new Card(
          ...
          borderRadius: new BorderRadius.circular(4.0)
               ...
               child:
                ...
                new Image.network(buildinglist[index].image)
              ...
              new Row(
               ...
               new Directionality(
                ...
                ,
                 ...
                 new CircleAvatar(backgroundImage: AssetImage('assets/img/jobs.png'),),
             ...
             new Container(
               ...
               child:
                Directionality(
                textDirection: TextDirection.rtl,
                 child:  new Text(buildinglist[index].title.toString(),style: TextStyle(
                            fontFamily: 'DroidSansArabic',
                            fontSize: 14,
                                          ...
                                          child: new ListView(
                                            ...
                                            children: <Widget>[
                                                ...
                                                child: new InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          buildinglist=building_subcategory_id_12;
                                                          ispressed1=12;
                                                        });
                                                      },
                                                      child: new Card(
                                           ...
                                           new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                          buildinglist=building_subcategory_id_11;
                                                          ispressed1=11;
                                                      });
                                                    },
                                                    child: new Card(
                                               ...
                                               new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=10;
                                                          buildinglist=building_subcategory_id_10;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 10
                                              ...
                                              new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=9;
                                                          buildinglist=building_subcategory_id_9;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 9
                                              ...
                                              new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                          ispressed1=8;
                                                          buildinglist=building_subcategory_id_8;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 8
                                               ...
                                               new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=7;
                                                          buildinglist=building_subcategory_id_7;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 7
                                               ...
                                               new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                          ispressed1=6;
                                                          buildinglist=building_subcategory_id_6;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 6
                                           ...
                                           new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=5;
                                                          buildinglist=building_subcategory_id_5;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 5
                                              ...
                                              new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=4;
                                                          buildinglist=building_subcategory_id_4;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 4
                                              ...
                                              new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=3;
                                                          buildinglist=building_subcategory_id_3;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 3
                                              ...
                                              new Container(
                                                ...
                                                child: new InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        ispressed1=2;
                                                          buildinglist=building_subcategory_id_2;
                                                      });
                                                    },
                                                    child: new Card(
                                                        color: ispressed1 == 2
