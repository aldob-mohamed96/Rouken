...
class building_ready extends StatefulWidget {
  @override
  _building_readyState createState() => _building_readyState();
}

class _building_readyState extends State<building_ready>
  ...
  final response = await http.get('https://rouckn.com/api/v1/category/4');
  ...
  int number_catergory=int.parse( u['subcategory_id'].toString());
      print(u['subcategory_id'].toString());
