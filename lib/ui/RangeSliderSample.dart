...
import 'package:flutter_range_slider/flutter_range_slider.dart';
 String lowervalue_search='300';
 String uppervalue_search='90000';
...
class _RangeSliderSampleState extends State<RangeSliderSample> {
  ...
  List<RangeSliderData> _rangeSliderDefinitions() {
    return <RangeSliderData>[
      RangeSliderData(
          min:300.0, max: 10000.0, lowerValue: 400.0, upperValue: 6000.0),
            ...
            child: new SliderTheme(
              ...
              child: new RangeSlider(
                ...
                onChanged: (double lower, double upper) {
                  ...
                  lowervalue_search=lower.toString();
                  uppervalue_search=upper.toString();
                },
              ),
            ),
          ),
