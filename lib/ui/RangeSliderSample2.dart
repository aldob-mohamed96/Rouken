...
String lower_value_search_price='30';

String upper_value_search_price='9000';
class RangeSliderSample2 extends StatefulWidget {

  @override
  _RangeSliderSample2State createState() => _RangeSliderSample2State();
}

class _RangeSliderSample2State extends State<RangeSliderSample2> {
  ...
  List<RangeSliderData> _rangeSliderDefinitions() {
    return <RangeSliderData>[
      RangeSliderData(
          min:5.0, max: 10000.0, lowerValue: 300.0, upperValue: 6000.0),
...
class RangeSliderData {
  ...
  static const Color defaultInactiveTrackColor = const Color(0xFFffffff);
              ...
              child: new RangeSlider(
                ...
                onChanged: (double lower, double upper) {
                  ...
                  callback(lower, upper);
                     lower_value_search_price=lower.toString();
                     upper_value_search_price=upper.toString();
                },
              ),
            ),
          ),
